    ...
    public void hienThiDuLieu()
    {
        ...
        for (int i = 0; i < nguoidung_table.Rows.Count; i++)
        {
            ltr_table.Text += @"<tr>
                                    ...
                                    <td> <a href='?id_sua=" + nguoidung_table.Rows[i][0] + @"'>Sửa</a> | <a href='?id=" + nguoidung_table.Rows[i][0] + @"'>Xóa</a> | <a href='them_de_thi.aspx?id=" + nguoidung_table.Rows[i][0] + @"'>Quản lý câu hỏi</a> </td>  
                                </tr>
                          ";
        }
