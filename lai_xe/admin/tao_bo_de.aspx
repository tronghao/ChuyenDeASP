<%@ Page Title="" Language="C#" MasterPageFile="../admin.master" AutoEventWireup="true" CodeFile="tao_bo_de.aspx.cs" Inherits="tao_bo_de" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    ...
    <tr>
        <td class="auto-style5" colspan="2">TẠO BỘ ĐỀ</td>
    </tr>
    <tr>
        <td class="auto-style4">Tên bộ đề: </td>
